...
<body>
	<div style="height: 10px;background-color: #27aae1;"></div>
	 <nav class="navbar navbar-expand-lg navbar-light bg-light" role="navigation">
			...
			<a href="index.php" style="margin-left:74px" class="navbar-brand"><img style="" src="images/logo.jpg" width="50" height="30">
				</a>	
			...
			<ul class="navbar-nav" style="margin-right:30px;">
				...
				<li class="nav-item"><a class="nav-link active" href="index.php" target="_blank">Blog</a></li>
