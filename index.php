	...
	<!--Navigation Start-->
	 <nav class="navbar navbar-expand-lg sticky-top" role="navigation" style="height: 55px;">
			...
			<ul class="navbar-nav" style="margin-right:20px;height: 100%;">
				...
				<li class="nav-item"><a class="nav-link active" href="index.php">Journalists</a></li>
			...
			<!--<form class="form-inline my-2 my-lg-0" style="margin-left: 212px;" method="post">
		     ...
		     <form class="form-inline">
	            <div class="input-group">                    
	                <input type="text" class="form-control" placeholder="Search Journalists, News Portals.." style="width:270px;margin-left: 0px;font-size: 17px;" name="search">
			...
			<div class="col-sm-12">
				<div class="clearfix justify-content-center">			
						...
						if(isset($_GET['search'])){
							$search=$_GET['search'];
							$viewquery="SELECT * FROM journalists WHERE datetime LIKE '%$search%' OR name LIKE '%$search%'";
							...
							<div class="card float-left" style="width: 15rem; height: 22rem;margin-left:20px;margin-right: 15px;margin-top: 45px;">
							  ...
							  <div class="card-body">
								...
								<div class="clearfix rating-area">
									...
									<a href="fullpost2.php?id=<?php echo $id; ?>"><span class="btn btn-rate">
