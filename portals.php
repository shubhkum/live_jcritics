...
<body>
	...
	<div style="height: 80px;background-color:#fffffff0;">				
			<a href="index.php" style="margin-left:100px;" ><img style="" src="images/logo.png" width="160" height="95">
				</a>			
				<p style="color: #000000FF;font-family: 'Lato', sans-serif;letter-spacing: 3px;font-size:25px;margin: 30px 350px 11px 7px;" class="float-right">A Platform to <span style="color:#E3C230;">Rate</span> your portals.</p>
	...
	<!--Navigation Start-->
	 <nav class="navbar navbar-expand-lg sticky-top" role="navigation" style="height: 55px;">
			...
			<ul class="navbar-nav" style="margin-right:20px;height: 100%;">
				...
				<li class="nav-item"><a class="nav-link" href="index.php">Journalists</a></li>
				<li class="nav-item"><a class="nav-link active" href="portals.php">Portals</a></li>
			...
			<!--<form class="form-inline my-2 my-lg-0" style="margin-left: 212px;" method="post">
			      <input class="form-control mr-sm-5" type="search" name="search" placeholder="Search portals , News... " aria-label="Search">
			      <button class="btn btn-outline-light my-2 my-sm-0" name="searchbtn" type="submit">Search</button>
		    </form>-->
		     <form class="form-inline">
	            <div class="input-group">                    
	                <input type="text" class="form-control" placeholder="Search portals, News Portals.." style="width:270px;margin-left: 0px;font-size: 17px;" name="search">
			...
			<div class="col-sm-12">
				<div class="clearfix justify-content-center">			
						...
						if(isset($_GET['search'])){
							$search=$_GET['search'];
							$viewquery="SELECT * FROM portals WHERE datetime LIKE '%$search%' OR name LIKE '%$search%'";
						...
						elseif(isset($_GET['page'])){
							...
							$showPostFrom=($page*12)-12;
								...
								$viewquery="SELECT * FROM portals ORDER BY datetime DESC LIMIT $showPostFrom,12";
						}

						else {
							$page=1;
							$viewquery="SELECT * FROM portals ORDER BY datetime DESC LIMIT 0,12";
						}
						 ...
						 <!--Pagination Start-->
								...
								<?php 
								 if(isset($page)){
									if($page>1){
										?>
									<li class="page-item"><a class="page-link" href="portals.php?page=<?php echo $page-1 ?>">&laquo;</a></li>
								...
								<?php 
									global $con;
									$queryPagination="SELECT COUNT(*) FROM portals";
									...
									<li class="page-item active"><a class="page-link" href="portals.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
										
								<?php
									}
								else{
									?>
									<li class="page-item"><a class="page-link" href="portals.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
								<?php
								}
									}
								}
								...
								if($page<$i-1){
								 ?>
									<li class="page-item"><a class="page-link" href="portals.php?page=<?php echo $page+1 ?>">&raquo;</a></li>
